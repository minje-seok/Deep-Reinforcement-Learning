...
if __name__ == '__main__':
    ...
    policy_net = D3QN(state_space, action_space).to(device) # policy net = main net
    target_net = D3QN(state_space, action_space).to(device) # target net
    target_net.load_state_dict(policy_net.state_dict())
    target_net.eval()
